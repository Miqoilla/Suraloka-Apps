...
<section class="w-full">
    <div class="relative max-w-full bg-white">
        <div class="flex flex-col pt-20 pb-16 items-center justify-center max-w-6xl lg:max-w-7xl mx-auto">
            <div class="flex flex-row w-full justify-center items-center mb-[20px]">
                <p class="font-baloo-2-bold text-[32px]">Merchandise Shop</p>
            </div>

            <div id="default-carousel" class="relative w-full h-[400px]" data-carousel="slide">
                <!-- Carousel wrapper -->
                <div class="relative h-[500px] overflow-hidden md:h-[400px]">
                    ...
                    <div class="rounded-[8px] hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('image/shop/bg-shop.png') }}" class="object-cover absolute block h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        <div class="text-white inset-0 absolute flex flex-col items-center justify-center">
                            ...
                            <a href="#our-product">
                                <button class="py-[12px] px-[80px] bg-amber-400 hover:bg-amber-500 rounded-full font-baloo-2-bold text-emerald-800 text-[16px]">Belanja
                                    Sekarang!</button>
                            </a>
                        </div>
                    </div>
        ...
        <div class="w-6xl lg:max-w-6xl justify-center mx-auto">
            <div class="flex flex-row justify-between">
                ...
                <div class="flex flex-col">
                    ...
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-emerald-800 bg-white hover:text-white hover:bg-emerald-800 ring-emerald-800 ring-1 focus:ring-2 focus:outline-none focus:ring-emerald-800 font-baloo-2-bold rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Default Sorting <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Default
                                    Sorting</a>
                            </li>
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Price
                                    Low-High</a>
                            </li>
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Price
                    ...
                    <div>
                        <div class="h-auto max-w-full rounded-lg bg-white shadow-lg shadow-slate-200 px-4 py-4">
                            ...
                            <div class="flex flex-row justify-between items-center mt-3">
                                ...
                                <a href="{{ auth()->check() ? route('detail-product', $p->id) : route('login.shop') }}" class="block mt-2">
                                    <button class="w-full flex items-center justify-center font-baloo-2-medium text-[12px] text-white bg-emerald-800 hover:bg-emerald-900 rounded-full py-2 px-4">
                                        <span class="iconify mr-1" data-icon="ic:outline-shopping-cart" data-inline="false" style="font-size: 14px;"></span> Beli
                                    </button>
                                </a>
